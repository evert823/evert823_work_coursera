'''
Created later for programming assignment 2 module 8
For extending TreeBinaryClassifier
--> to handle weighted data points
--> Backwards compatible for earlier assignments
'''
import pandas as pd
